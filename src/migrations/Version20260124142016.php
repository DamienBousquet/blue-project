 ...
 */
final class Version20260124142016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE food_place ADD rating_avg NUMERIC(10, 2) DEFAULT NULL');
        $this->addSql('ALTER TABLE food_place ADD latitude NUMERIC(10, 2) NOT NULL');
        $this->addSql('ALTER TABLE food_place ADD longitude NUMERIC(10, 2) NOT NULL');
        $this->addSql('ALTER TABLE food_place ADD is_open BOOLEAN NOT NULL');
        $this->addSql('ALTER TABLE food_place ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL');
        $this->addSql('ALTER TABLE food_place DROP location');
        $this->addSql('ALTER TABLE food_place ALTER name TYPE TEXT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE food_place ADD location VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE food_place DROP rating_avg');
        $this->addSql('ALTER TABLE food_place DROP latitude');
        $this->addSql('ALTER TABLE food_place DROP longitude');
        $this->addSql('ALTER TABLE food_place DROP is_open');
        $this->addSql('ALTER TABLE food_place DROP created_at');
        $this->addSql('ALTER TABLE food_place ALTER name TYPE VARCHAR(255)');
    }
}
