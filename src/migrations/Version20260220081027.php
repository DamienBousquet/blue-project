 ...
 */
final class Version20260220081027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utils (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, value TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN utils.created_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE dish ALTER image_path SET NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_957D8CB8778453BA ON dish (food_place_id_id)');
        $this->addSql('ALTER TABLE food_place ALTER icon SET NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dish ALTER image_path DROP NOT NULL');
        $this->addSql('CREATE INDEX IDX_957D8CB8778453BA ON dish (food_place_id_id)');
        $this->addSql('ALTER TABLE food_place ALTER created_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE food_place ALTER icon DROP NOT NULL');
